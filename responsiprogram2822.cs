...
namespace  ResponsiPemrog2822
{
     Program kelas
    {
        static  void  Main ( string [] args )
        {
            Karyawan  k1  =  Karyawan baru  ( " 19112822 " , " Arsandi " , 3000000 );
            Tampil ( k1 );
            Karyawan  k2  =  Karyawan baru  ( " 08052001 " , " Wira " , 2000000 );
            Tampil ( k2 );

            Konsol . WriteLine ( " \ n Mantap mantap gaji naik 10% \ n " );
            Tampil2 ( k1 );
            Tampil2 ( k2 );
